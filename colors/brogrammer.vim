...
hi DiffAdd ctermfg=231 ctermbg=64 cterm=bold guifg=#4cd137 guibg=#44800a gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#e84118 guibg=NONE gui=NONE
hi DiffChange ctermfg=231 ctermbg=23 cterm=NONE guifg=#fbc531 guibg=#1d3251 gui=NONE
hi DiffText ctermfg=231 ctermbg=40 cterm=bold guifg=#ffffff guibg=#00df00 gui=bold
